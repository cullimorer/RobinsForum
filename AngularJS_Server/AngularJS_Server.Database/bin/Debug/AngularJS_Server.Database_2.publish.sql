...
GO
ALTER TABLE [dbo].[Users] DROP CONSTRAINT [FK_OauthUsers_OauthProviders];


GO
PRINT N'Starting rebuilding table [dbo].[OauthProviders]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_OauthProviders] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[OauthProviders])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_OauthProviders] ON;
        INSERT INTO [dbo].[tmp_ms_xx_OauthProviders] ([Id], [Name])
        SELECT   [Id],
                 [Name]
        FROM     [dbo].[OauthProviders]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_OauthProviders] OFF;
    END

DROP TABLE [dbo].[OauthProviders];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_OauthProviders]', N'OauthProviders';
